    ...
    return (
        <div className='w-screen flex flex-col items-center min-h-screen justify-center'>
            ...
            <form autoComplete='on' action="" className='text-sm w-72 py-4 relative'>
                ...
                <button onClick={onLogin} className="w-full px-4 py-2 mt-8 rounded-3xl focus:outline-none hover:bg-indigo-700 hover:scale-105 duration-300 transition-all bg-indigo-500 text-white font-semibold">Login</button>
